...
# Legacy AMD-specific Google Trends script.
# Replaced by the generic pipeline:
#   SYMBOL=AMD KEYWORD="AMD stock" bash scripts/run_stock_full_pipeline.sh data
...
def main() -> None:
    ...
    daily = daily.reset_index().rename(columns={"value": "amd_stock_trends"})
