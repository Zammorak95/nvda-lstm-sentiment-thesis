#!/usr/bin/env python3
"""LSTM regression: predict next-day return (target_next_return).
Optionally outputs implied next close: close_t * exp(predicted_log_return).
...
def build_model(lookback, n_features, lr, lstm_units, dropout, rec_dropout):
    model = models.Sequential([
        ...
        # ROCm-safe LSTM: non-fused implementation
        layers.LSTM(
            lstm_units,
...
def main():
    ...
    ap.add_argument("--predict_close", action="store_true")
    args = ap.parse_args()
